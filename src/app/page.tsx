...
export default function Home() {
  ...
  return (
    ...
    <QueryClientProvider client={queryClient}>
      ...
      <section className="max-w-[1380px] px-[10px] mx-auto  section scroll-mt-[240px]"
      ...
      <section className="max-w-[1380px] px-[10px] mx-auto section scroll-mt-[240px]" id="xarita">
        <div className="flex justify-between mb-[36px] section-title">
          <div>
            <Badge
      ...
      <section className=" mg-[80px] section scroll-mt-[240px]">
      ...
      <section className="max-w-[1380px] mx-auto mb-[140px] px-[10px] section scroll-mt-[240px]"
        id="aboutus"
      >
        <div className="max-w-[1360px] mx-auto flex justify-between mb-[36px] section-title px-[10px]">
          <div>
