...
import ProfileContentSimple from "./ProfileContentSimple";
...
export default function ProfilePage() {
  ...
  return (
    <ProtectedRoute>
      <div className="max-w-[1380px] px-4 sm:px-6 lg:px-10 mx-auto">
        <nav className="flex items-center text-sm text-muted-foreground h-14 mb-8 sm:mb-12 lg:mb-16">
          <Link href="/" className="hover:text-primary">
            {t("breadcrumbs.home")}
          </Link>
          <span className="mx-2">/</span>
          ...
          <div className="flex-1">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                transition={{ duration: 0.3 }}
                className="bg-white rounded-lg border p-4 sm:p-6 min-h-[500px]"
              >
                {activeTab === "profile" && (
