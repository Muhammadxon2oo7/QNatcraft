...
const MessageList: React.FC<MessageListProps> = React.memo(({
  ...
  return (
  <div className="flex-1 overflow-y-auto p-3 sm:p-4 bg-gray-50 relative scrollbar-thin scrollbar-thumb-gray-300 pb-24 max-h-[calc(100vh-200px)]">
    <AnimatePresence>
      {Object.entries(groupedMessages).map(([date, groupedMsgs]) => (
        <div key={date}>
          <div className="text-center my-3">
    ...
    </AnimatePresence> {/* ✅ endi to‘g‘ri joyda yopildi */}
    <div ref={messagesEndRef} />
  </div>
);
