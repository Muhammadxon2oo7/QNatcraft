...
export const Header = () => {
  ...
  const renderAuthButton = () => {
    ...
    if (user) {
      return (
        <div className="flex items-center gap-2">
          <Button
            className="w-[clamp(140px,10vw,180px)] rounded-[16px] bg-[#fadee0] flex items-center gap-2"
          ...
          >
            ...
            />
            <Link href="/Xprofile" className="font-medium text-[18px] text-[#820C0F]">
              {user.profile.user_first_name}
            </Link>
          </Button>
          <Button
    ...
    return (
      <Button
        className="w-[clamp(140px,10vw,180px)] rounded-[16px] bg-primary text-white"
        asChild
  ...
  const renderMobileAuthButton = () => {
    ...
    if (user) {
      return (
        <div className="flex flex-col gap-2">
          <Button className="w-full text-white" asChild aria-label={`${user?.profile?.user_first_name} profiliga o'tish`}>
            <Link href="/profile">{user?.profile?.user_first_name}</Link>
          </Button>
          <Button className="w-full bg-red-500 text-white" onClick={logout} aria-label="Chiqish">
            {t("logout")}
          </Button>
        </div>
      );
    ...
    return (
      <Button className="w-full text-white" asChild aria-label="Kirish sahifasiga o'tish">
        <Link href="/login">{t("login")}</Link>
      </Button>
    );
  };
                ...
                <div className="flex h-full flex-col">
                  ...
                  <nav className="flex-1">
                    ...
                    <div className="flex flex-col gap-2 p-4 border-t">
                      ...
                      <Link href="/chat" className="flex items-center gap-3" aria-label="Chat sahifasiga o'tish">
                        <MessageCircle className="h-5 w-5" />
                        <span>{t("chat") || "Chat"}</span>
                      </Link>
                      <Link href="#" className="flex items-center gap-3" aria-label="Sevimlilar sahifasiga o'tish">
                        <Heart className="h-5 w-5" />
                        {t("favorites") || "Sevimlilar"}
                      </Link>
                      <Link href="#" className="flex items-center gap-3" aria-label="Qidirish sahifasiga o'tish">
                        <Search />
                        {t("search") || "Qidirish"}
                      </Link>
                    </div>
      ...
      <header className="fixed top-0 left-0 right-0 bg-white h-[156px] w-full shadow-md z-[100]">
        <div className="flex max-w-[1380px] mx-auto px-[10px] justify-between items-center h-[100px]">
          ...
          <div className="flex gap-[16px] items-center">
            <AnimatedSearchTransform />
            <Link href="/chat" aria-label="Chat sahifasiga o'tish">
              <Button className="bg-[#f6f6f6] hover:bg-primary flex gap-[8px] text-[#242b3a] hover:text-white">
                <ChatIcon />
              </Button>
            </Link>
            <Button
              className="bg-[#f6f6f6] hover:bg-[#f6f6f6] relative"
              onClick={showCartToast}
              aria-label="Savatcha"
            >
              <CartIcon />
