...
export const Header = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        const data = await getUserInfo() as { name: string };
              ...
              <div className="flex h-full flex-col">
                ...
                <nav className="flex-1">
                  ...
                  <div className="mt-auto p-4 border-t">
                    ...
                    {userName ? (
                      <Button className="w-full text-white">{userName}</Button>
                    ) : (
          ...
          <div className="flex gap-[12px] md:gap-[16px] py-[20px] md:py-[28px] flex-wrap flex-grow justify-end items-center">
            ...
            <div>
              {userName ? (
                ...
                <Button className="responsive-btn bg-[#fcdbdb] w-[clamp(140px, 10vw, 180px)] rounded-[16px]">
                  <Link href="/login" className="responsive-text bg-gradient-to-br from-[#9e1114] to-[#530607] bg-clip-text text-transparent">
                    Kirish
                  </Link>
                  <Login />
                </Button>
