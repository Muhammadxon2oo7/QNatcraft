...
//             toast(<span className="flex items-center gap-2">{<Mail />} {tauth("register.verificationEntry")}</span>);
...
//           <Label htmlFor="username" className="font-normal text-xs leading-5 text-gray-500">{tauth("register.name")}</Label>
...
//         <div className="space-y-1">
//           <Label htmlFor="email" className="font-normal text-xs leading-5 text-gray-500">{tauth("register.email")}</Label>
//           <div className="relative">
//             <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none">
//               <Mail />
//             </div>
...
//         <div className="space-y-1">
//           <Label htmlFor="password" className="font-normal text-xs leading-5 text-gray-500">{tauth("register.password")}</Label>
//           <div className="relative">
//             <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none">
//               <Lock />
//             </div>
...
//         <div className="space-y-1">
//           <Label htmlFor="confirmPassword" className="font-normal text-xs leading-5 text-gray-500">{tauth("register.confirmPassword")}</Label>
//           <div className="relative">
//             <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none">
//               <Lock />
//             </div>
...
//           {tauth("register.loginRecommidation.first")} <Link href="/auth/login">{tauth("register.loginRecommidation.second")}</Link>
//         </div>
//       </form>
//     </div>
//   )
...
export default function RegisterForm({ onSubmit }: { onSubmit: () => void }) {
    ...
    // Fetch user data from localStorage and set the initial values if it exists
    useEffect(() => {
        ...
        if (storedUserData) {
            ...
            setFormData({
                ...
                email: '', // Always leave email empty to let user fill it
  ...
  return (
    <div className="w-full max-w-md mx-auto p-2">
      ...
      <form onSubmit={handleSubmit} className="space-y-5 mb-[10px]">
      ...
      {tauth("register.loginRecommidation.first")}  <Link href={'/login'} className="font-semibold underline bg-gradient-to-br from-red-800 to-red-900 bg-clip-text text-transparent">{tauth("register.loginRecommidation.second")}</Link>
      </p>
      <Toaster />
    </div>
  )
