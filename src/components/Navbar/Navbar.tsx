  ...
  return (
    <nav className="primary-bg flex h-[56px] items-center ">
      <div className="container h-[100%] flex items-center   text-white font-medium">
        <Link href="/" className="mr-[47px]" >Biz haqimizda</Link>
        <span className="text-white text-opacity-20">|</span>
        <Link href="/" className="mx-[47px]">Madaniy me'ros</Link>
        <span className="text-white text-opacity-20">|</span>
        <Link href="/" className="mx-[47px]">Hunarmandchilik turlari</Link>
        <span className="text-white text-opacity-20">|</span>
        <Link href="/" className="mx-[47px]">Hunarmandlar</Link>
        <span className="text-white text-opacity-20">|</span>
