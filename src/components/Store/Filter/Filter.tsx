...
//             if (option) {
//               option.checked = !option.checked; // Tanlangan kategoriya o'zgaradi
//             }
//           }
//         });
//       });

//       // setSections ichida `sections` o'zgaruvchisi yangilanmaydi, shuning uchun oldin yangilashni kutish kerak
//       setTimeout(() => {
//         setSections((prev) => {
...
//           onFilterChange(updatedCategories, sortByDiscount);
//           return prev;
//         });
//       }, 0);
//     },
//     [onFilterChange, sortByDiscount]
//   );
...
//       // Immediately call onFilterChange with the new discount value
//       // but preserve the current category selection
//       setTimeout(() => {
//         console.log("Discount filter toggled to:", newValue)
//         console.log("Preserving selected categories:", selectedCategories)
//         onFilterChange(selectedCategories, newValue)
//       }, 0)
//       return newValue
//     })
//   }, [getSelectedCategories, onFilterChange])
...
//     // Call onFilterChange with empty categories and false for sortByDiscount
//     setTimeout(() => {
...
//           console.error("Kategoriyalarni olishda xatolik: ", error);
//           setError(
//             "Kategoriyalarni yuklashda xatolik yuz berdi. Iltimos, qayta urinib ko'ring."
//           );
//         } finally {
//           setLoading(false);
//         }
...
//         // Call onFilterChange with the updated categories
...
//     // Call onFilterChange with empty categories
//     onFilterChange([], false);
//   }, [onFilterChange]);
...
//   useEffect(() => {
//     console.log("Current checkedOptions:", checkedOptions);
//     console.log("Selected categories:", getSelectedCategories());
//   }, [checkedOptions, getSelectedCategories]);
...
//       ) : (
//         <div className="divide-y divide-gray-200">
//           <div className="flex flex-wrap flex-grow  p-[4px] rounded-[16px]   bg-[#f6f6f6] items-center justify-between mb-[20px]  border-gray-200">
...
//             <Button
//               variant="default"
//               className="rounded-[12px] w-[44px] h-[44px] flex justify-center items-center"
//             >
//               <Search size={20} />
//             </Button>
//           </div>
...
//               <Check
//                 size={20}
//                 className={sortByDiscount ? "text-primary" : "invisible"}
//               />
//             </button>
//           </div>
//           {sections.map((section) => (
...
//                           <div
//                             key={option.id}
//                             className="flex items-center space-x-3 p-[5px]"
//                           >
//                             <button
//                               type="button"
//                               onClick={() =>
